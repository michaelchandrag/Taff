		...
		<section id="content">
			<div class="container">
				<div class="section">
                    ...
                    <div id="card-stats">
                        <div class="row">
                        		<?php foreach ($boardMember as $member) { ?>
                        		    <?php if ($member->favoriteChecked == '1') { ?>
                                        <?php foreach ($board as $b) { ?>
                                            <?php if ($b->boardId == $member->boardId && $b->boardClosed == '0' && $b->boardStatus == '1' && $member->memberStatus == '1') { ?>
                                                <div class="col s12 m6 l3">
                                                    <div class="card">
                                                        <a href="board?id=<?= $b->boardId ?>" >
                                                            <div class="card-content <?= $b->boardBackground ?> black-text">
                                                                <?php $warna_teks = 'black_text'; ?>
                                                                    <?php if ($b->boardBackground == 'red' || $b->boardBackground == 'blue' || $b->boardBackground == 'green') { ?>
                                                                        <?php $warna_teks = 'white-text'; ?>
                                                                    <?php } else { ?>
                                                                        <?php $warna_teks = 'black-text'; ?>
                                                                    <?php } ?>
            		...
            		<div id="card-stats">
           			...
           			<div id="ajaxBoard<?= $userId ?>" style="margin-top:-25px;">
                        ...
                        <?php if ($bm->userId == $userId && $bm->memberStatus == '1') { ?>
                            <?php foreach ($board as $r) { ?>
                                <?php if ($r->boardGroup == '0' && $r->boardClosed == '0' && $r->boardStatus == '1' && $r->boardId == $bm->boardId) { ?>
                                        ...
                                        <a href="board?id=<?= $r->boardId ?>" >
                                            <div class="card">
                                                ...
                                                <div class="card-content <?= $r->boardBackground ?> black-text boardUser">
                                                    <?php $warna_teks = 'white-text'; ?>
                                                    <?php if ($r->boardBackground == 'red' || $r->boardBackground == 'blue' || $r->boardBackground == 'green') { ?>
                                                        <?php $warna_teks = 'white-text'; ?>
                                                    <?php } else { ?>
                                                        <?php $warna_teks = 'black-text'; ?>
                                                    <?php } ?>
