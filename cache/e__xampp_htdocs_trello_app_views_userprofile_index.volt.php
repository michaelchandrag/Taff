		        ...
		        <div id="profile-page" class="section">
		            <div id="profile-page-header" class="card">
		                ...
		                <div class="card-content" style="margin-top:6px;">
		                  <div class="row">                    
		                    <div class="col s3 offset-s2" style="">                         
		                    ...
		                    <div class="col s2 center-align">
		                        <h4 class="card-title grey-text text-darken-4">
                                    ...
                                    <?php foreach ($board as $b) { ?>
                                        <?php if ($b->boardStatus == '1' && $b->boardGroup == '0') { ?>
                                            <?php $total += 1; ?>
                                        <?php } ?>
                                    <?php } ?>
                                    <?= $total ?>
		                    ...
		                    <div class="col s2 center-align">
                                ...
                                <?php $total = 0; ?>
                                    <?php foreach ($groupMember as $g) { ?>
                                        <?php if ($g->memberStatus == '1') { ?>
                                            <?php foreach ($groupUser as $u) { ?>
                                                <?php if ($g->groupUserId == $u->groupId) { ?>
                                                    <?php $total += 1; ?>
                                                <?php } ?>
                                            <?php } ?>
                                        <?php } ?>
		                        ...
		                        <p class="medium-small grey-text">Teams</p>                        
		                    </div>                   
		                    <div class="col s2 center-align">
                            ...
                            <div class="collapsible-body" style="display: none;">
                              <p>
                                ...
                                <?php foreach ($groupMember as $g) { ?>
                                    <?php if ($g->memberStatus == '1') { ?>
                                        <?php foreach ($groupUser as $u) { ?>
                                            <?php if ($g->groupUserId == $u->groupId && $u->groupStatus == '1') { ?>
