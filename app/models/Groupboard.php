...
class Groupboard extends \Phalcon\Mvc\Model
{
     ...
     *
     * @var string
     * @Column(column="boardCreated", type="string", length=20, nullable=false)
     */
    public $boardCreated;
     ...
     * @return Groupboard[]|Groupboard|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Groupboard|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public function insertGroupBoard($owner,$title,$public,$status,$background)
    {
