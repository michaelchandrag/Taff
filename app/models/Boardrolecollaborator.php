...
class Boardrolecollaborator extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSchema("taff");
        $this->setSource("boardrolecollaborator");
     ...
     * @return Boardrolecollaborator[]|Boardrolecollaborator|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Boardrolecollaborator|\Phalcon\Mvc\Model\ResultInterface
     */
    ...
    public function countRoleCollaborator()
    {
        $role = Boardrolecollaborator::find();
        return count($role);
    }

    public function insertBoardRoleCollaborator($boardId,$listCreate,$listEdit,$listDelete,$cardCreate,$cardEdit,$cardDelete,$activityAM,$activityLabel,$activityChecklist,$activityStartDate,$activityDueDate,$activityAttachment,$roleStatus)
    {
        $role = new Boardrolecollaborator();
        $index = $role->countRoleCollaborator();
    ...
    public function setRoleCollaborator($boardId,$listCreate,$listEdit,$listDelete,$cardCreate,$cardEdit,$cardDelete,$activityAM,$activityLabel,$activityChecklist,$activityStartDate,$activityDueDate,$activityAttachment)
    {
        $role = Boardrolecollaborator::findFirst(
            [
                "boardId='".$boardId."'"
            ]
        );
